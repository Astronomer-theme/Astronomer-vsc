 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} moon - moon color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.moon.ansi, ...soft.moon.brightOther];
