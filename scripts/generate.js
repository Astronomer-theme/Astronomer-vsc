 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} astronomer - astronomer color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.astronomer.ansi, ...soft.astronomer.brightOther];
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'astronomer.yml'),
        'utf-8'
    );
